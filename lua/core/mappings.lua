...
M.general = {
  ...
  t = {
    ...
    ["<Escape>"] = { vim.api.nvim_replace_termcodes("<C-\\><C-N>", true, true, true), "Escape terminal mode" },
  },
...
M.lspconfig = {
  ...
  n = {
    ...
    ["<leader>q"] = {
      function()
        vim.diagnostic.setloclist { open = not vim.diagnostic.getloclist } -- don't open and focus
...
M.nvimtree = {
  ...
  n = {
    ...
    ["<leader>xf"] = { "<cmd> NvimTreeFocus <CR>", "Focus nvimtree" },
  },
}
